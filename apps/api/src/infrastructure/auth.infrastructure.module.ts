...
import { PrismaStudentVerificationRequestRepository } from './repositories/prisma-student-verification-request.repository';
...
@Module({
  ...
  exports: [USER_REPOSITORY, UNIVERSITY_REPOSITORY, EMAIL_VERIFICATION_TOKEN_REPOSITORY, REFRESH_TOKEN_REPOSITORY, STUDENT_VERIFICATION_REQUEST_REPOSITORY, EMAIL_SERVICE, TOKEN_SERVICE],
})
